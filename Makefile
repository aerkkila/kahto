...
LDLIBS += -lm -lpng
OBJECTS =
kahto_sources = kahto.h kahto_draw_graph.c kahto_draw_graph_markers.c kahto_draw_graph_lines.c rotate.c functions.c ticker.c layout.c kahto_png.c kahto_draw_line.c kahto_draw_line_more.c kahto_draw_triangle.c kahto_draw.c kahto_text.c kahto_colormesh.c kahto_init_markers.c kahto_new_init.c kahto_find_empty_rectangle.c kahto_async.c kahto_mkdir.c Makefile
