...
cplot.o: cplot.c cplot.h rendering.c rotate.c data_to_pixels.c ticker.c wayland_helper/waylandhelper.o Makefile
	gcc -c -Wall -g -o $@ $<

wayland_helper/waylandhelper.o: wayland_helper/*.[ch]
	cd wayland_helper && $(MAKE) waylandhelper.o

data_to_pixels.c: make_functions.pl data_to_pixels.in.c
	./$<
