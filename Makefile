testi.out: testi.c cplot.o wayland_helper/waylandhelper.o
	gcc -o $@ $^ -g -Wall -lxkbcommon -lwayland-client -lm -lttra

cplot.o: cplot.c cplot.h rendering.c rotate.c functions.c ticker.c commit.c wayland_helper/waylandhelper.o Makefile
	gcc -c -Wall -g -o $@ $<
